...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2021"),"Partiu viagem", "Vou viajar para são paulo", bob);
		Post post2 = new Post(null,sdf.parse("23/04/2021"),"Bom dia ", "Acordei Feliz Hoje!", maria);
